...
export function Strands({
  colors = ['#55d396', '#169a50', '#34d399', '#ffffff'],
  count = 3,
  speed = 0.5,
  amplitude = 1,
  waviness = 1,
  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        uTime: { value: 0 },
        uResolution: { value: [ctn.offsetWidth || 100, ctn.offsetHeight || 36] },
    ...
    const renderTarget = new RenderTarget(gl, {
      width: ctn.offsetWidth || 100,
      height: ctn.offsetHeight || 36,
    })
    ...
    function resize() {
      if (!ctn) return
      const width = ctn.offsetWidth || 100
      const height = ctn.offsetHeight || 36
